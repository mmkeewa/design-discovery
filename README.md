...
Опционально для расширений в будущем — Figma MCP (для авто-сборки в FigJam).
...
Roadmap:
- v0.2 — `consolidate-memory`: skill запоминает удачные брифы и угадывает направления при следующих запусках
- v0.2 — авто-сборка FigJam через Figma MCP по выборам пользователя
- v0.3 — A/B mode: ведёт два параллельных мудборда под разные направления одного брифа
- v0.3 — quick scan: Layer 1 only, для проверки гипотезы за 1 минуту
